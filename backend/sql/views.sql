...
-- vw_top_scorers  (added team_id so frontend can group by team)
...
GROUP BY p.player_id, p.name, p.jersey_no, p.position, p.team_id, t.name, t.color
ORDER BY goals DESC, assists DESC;

-- vw_fixture_schedule  (added home_team_id, away_team_id, venue_id so frontend can look them up)
